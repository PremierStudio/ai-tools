...
import { DroidAgentAdapter } from "./droid.js";

describe("DroidAgentAdapter", () => {
  let adapter: DroidAgentAdapter;
  ...
  describe("metadata", () => {
    ...
    it("has correct configDir", () => {
      expect(adapter.configDir).toBe(".factory/agents");
    });
  });
  ...
  describe("generate", () => {
    ...
    it("generates file at correct path", async () => {
      ...
      expect(files[0]!.path).toBe(".factory/agents/reviewer.md");
    });
