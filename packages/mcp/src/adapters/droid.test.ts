...
describe("DroidMCPAdapter", () => {
  ...
  describe("metadata", () => {
    ...
    it("has correct config path", () => expect(adapter.configPath).toBe(".factory/mcp.json"));
  });
  ...
  describe("generate", () => {
    it("generates valid JSON config", async () => {
      ...
      expect(files[0]!.path).toBe(".factory/mcp.json");
